  ...
  return (
    <div className="font-sans text-gray-900 min-h-screen overflow-auto">
      ...
      <div className="flex flex-col items-center justify-center h-full bg-pink-50 mt-2">
        ...
        Kelebihan casual meliputi anda bisa tetap tampil profesional tetapi lebih santai, memberikan kesan yang lebih modern dan sesuai dengan acara yang lebih informal atau semi-formal. Gaya ini sangat fleksibel dan cocok untuk berbagai kesempatan.</p>      </div>
