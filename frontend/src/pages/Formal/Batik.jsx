...
function Batik() {
  ...
  const additionalImages = [
    '/asset/image/download (18).jpeg',
    '/asset/image/download (19).jpeg',
    '/asset/image/Iwan Tirta Private Collection for JFW 2021.jpeg',
  ...
  return (
    <div className="font-sans text-gray-900 min-h-screen overflow-auto">
      ...
      <div className="flex flex-col items-center justify-center h-full bg-pink-50 mt-2">
        ...
        Kelebihan batik meliputi tidak hanya tampil modis, tetapi juga melestarikan warisan budaya Indonesia. Batik adalah pilihan sempurna untuk tampil elegan dan mencerminkan kebanggaan terhadap budaya tradisional, sambil tetap sesuai dengan kebutuhan modern.        </p>      </div>
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md w-full max-w-sm">  {/* Adjusted max-w-sm for smaller card */}
                ...
                <div className="p-4 mt-4">  {/* Added margin-top to create space between the image and the text */}
                  <p className="text-center text-gray-800 font-semibold">Batik Item {index + 1}</p>
                </div>
              </div>
            </div>
          ))}
