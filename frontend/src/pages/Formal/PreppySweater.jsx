...
function PreppySweater() {
  ...
  const additionalImages = [
    '/asset/image/andiisbae on Instagram.jpeg',
    '/asset/image/download (49 ).jpeg',
  ...
  return (
    <div className="font-sans text-gray-900 min-h-screen overflow-auto">
      ...
      <div className="flex flex-col items-center justify-center h-full bg-pink-50 mt-2">
        ...
        Kelebihan preppy sweater dapat memberikan kesan tampil elegan, terstruktur, dan nyaman dalam satu tampilan. Gaya ini cocok untuk berbagai kesempatan, memberikan kesan cerdas dan modis tanpa perlu berusaha terlalu keras.        </p>      </div>
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md w-full max-w-sm">  {/* Adjusted max-w-sm for smaller card */}
                ...
                <div className="p-4 mt-4">  {/* Added margin-top to create space between the image and the text */}
                  <p className="text-center text-gray-800 font-semibold">Preppy Sweater Item {index + 1}</p>
                </div>
              </div>
            </div>
          ))}
