...
function Vintage() {
  ...
  useEffect(() => {
    ...
    const fetchGaleri = async () => {
      try {
        const response = await fetch('https://vastra-backend.vercel.app/api/galeris/kategori/Khusus/subCategory/Vintage');
      ...
      {selectedImage && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white p-4 w-full max-w-sm max-h-[90vh] relative">
            ...
            <img src={`https://vastra-backend.vercel.app${selectedImage}`} alt="Selected Vintage Outfit" className="w-full mb-4 max-w-full" />
