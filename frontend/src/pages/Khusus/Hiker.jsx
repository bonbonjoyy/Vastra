...
function Hiker() {
  ...
  const additionalImages = [
    '/asset/image/Karrimor Japan SS19 Provides Sophisticated Hiking Style.jpeg',
    '/asset/image/The Shelter.jpeg',
    '/asset/image/HAVEN Winter 2019 Editorial.jpeg',
    '/asset/image/Goldwin Goes Tech-Heavy for SS21.jpeg',
    '/asset/image/NIKE ACG Winter 2020.jpeg',
    '/asset/image/download (39).jpeg', // Gambar tambahan
  ];
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md w-full max-w-sm">  {/* Adjusted max-w-sm for smaller card */}
                ...
                <div className="p-4 mt-4">  {/* Added margin-top to create space between the image and the text */}
                  <p className="text-center text-gray-800 font-semibold">Hiker Item {index + 1}</p>
                </div>
              </div>
            </div>
          ))}
