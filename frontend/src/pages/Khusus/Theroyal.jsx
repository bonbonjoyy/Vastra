  ...
  return (
    <div className="font-sans text-gray-900 min-h-screen overflow-auto">
      ...
      <div className="flex flex-col items-center justify-center h-full bg-pink-50 mt-2">
        ...
        Kelebihan the royal merupakan pilihan sempurna untuk tampil luar biasa di acara-acara formal. Kombinasi pakaian berkualitas tinggi, desain elegan, dan aksesori mewah menciptakan tampilan yang tidak hanya anggun tetapi juga meninggalkan kesan mendalam.        </p>      </div>
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md w-full max-w-sm">  {/* Adjusted max-w-sm for smaller card */}
                ...
                <div className="p-4 mt-4">  {/* Added margin-top to create space between the image and the text */}
                  <p className="text-center text-gray-800 font-semibold">The Royal Item {index + 1}</p>
                </div>
              </div>
            </div>
          ))}
