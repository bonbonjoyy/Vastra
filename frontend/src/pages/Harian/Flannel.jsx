...
function Flannel() {
  ...
  const additionalImages = [
    '/asset/image/Flannel Overshirt.jpeg',
    '/asset/image/PLAID FLANNEL SHIRT.jpeg',
    '/asset/image/download (22).jpeg',
    '/asset/image/BEIGE CHECK FLANNEL SHIRT in neutrals  _ Off-White™ Official ID.jpeg',
    '/asset/image/download (23).jpeg',
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md w-full max-w-sm">  {/* Adjusted max-w-sm for smaller card */}
                ...
                <div className="p-4 mt-4">  {/* Added margin-top to create space between the image and the text */}
                  <p className="text-center text-gray-800 font-semibold">Flannel Item {index + 1}</p>
                </div>
              </div>
            </div>
          ))}
