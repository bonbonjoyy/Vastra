...
function Tropical() {
  ...
  const additionalImages = [
    '/asset/image/download (20).jpeg',
    '/asset/image/download (21).jpeg',
    '/asset/image/View All ___ New Man _ ZARA Malaysia - Page 2.jpeg',
    '/asset/image/Zara.jpeg',
    '/asset/image/Essential summer shirts every man needs.jpeg',
  ...
  return (
    <div className="font-sans text-gray-900 min-h-screen overflow-auto">
      ...
      <div className="flex flex-col items-center justify-center h-full bg-pink-50 mt-2">
        ...
        Outfit tropical untuk pria adalah gaya berpakaian yang dirancang untuk memberikan kenyamanan dan gaya di cuaca tropis yang panas dan lembap. Outfit ini memadukan pakaian ringan, bahan bernapas, dan motif yang segar untuk menciptakan tampilan santai namun tetap stylish.        </p>
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md w-full max-w-sm">  {/* Adjusted max-w-sm for smaller card */}
                ...
                <div className="p-4 mt-4">  {/* Added margin-top to create space between the image and the text */}
                  <p className="text-center text-gray-800 font-semibold">Tropical Item {index + 1}</p>
                </div>
              </div>
            </div>
          ))}
