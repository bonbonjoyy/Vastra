...
import EWalletTransfer from "../../components/EWallet Transfer"; // Komponen baru untuk e-wallet
...
export default function DetailEwallet() {
    const [selectedEWallet, setSelectedEWallet] = useState(null); // State untuk menyimpan e-wallet yang dipilih
    ...
    const eWalletDetails = {
        Dana: {
            title: "Dana",
            description: "Lakukan Pembayaran menggunakan e-wallet Dana.",
            companyCode: "1111",
            virtualAccount: "22222",
        },
        GoPay: {
            title: "GoPay",
            description: "Lakukan Pembayaran menggunakan e-wallet GoPay.",
            companyCode: "3333",
            virtualAccount: "44444",
        },
        ShopeePay: {
            title: "ShopeePay",
            description: "Lakukan Pembayaran menggunakan e-wallet ShopeePay.",
            companyCode: "5555",
            virtualAccount: "66666",
        },
    };

    const details = eWalletDetails[selectedEWallet] || {};
                    ...
                    <div className="container-xs mb-1 md:px-5 items-left">
                        <div className="flex flex-col gap-8 sm:gap-4">
                            ...
                            <div className="mr-[500px] flex flex-col gap-[40px] self-stretch md:mr-0"> 
                                <EWalletTransfer onSelectEWallet={handleEWalletSelect} />
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="flex flex-col gap-4 px-4 sm:px-2">
                                    <div className="flex">
                                        <Text as="p" className="mt-1 mb-5 w-[90%] text-[16px] font-normal leading-5 text-black">
                                            {details.description || "Silakan pilih e-wallet untuk melihat detail pembayaran."}
                                        </Text>
                                    </div>
