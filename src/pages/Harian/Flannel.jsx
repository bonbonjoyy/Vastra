  ...
  return (
    <div className="font-sans text-gray-900 h-screen overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <h2 className="text-5xl font-bold mb-6">Flannel</h2>
          <p className="text-black mt-1 mb-8 text-justify">          Flannel adalah bahan yang populer untuk pria yang ingin tampil kasual, maskulin, dan tetap stylish. Dengan tekstur yang hangat dan motif kotak-kotak yang khas, flannel memberikan nuansa yang unik pada setiap outfit          
          </p>
          <button 
