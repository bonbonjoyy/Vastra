      ...
      <div className="w-full bg-white-a700">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-5 mx-4 md:mx-0">
          ...
          <div className="flex flex-col items-start w-full md:w-1/2 md:px-5 md:mb-0 lg:pb-[200px]">
            ...
            >
              Selamat datang di Vastra! Kami hadir sebagai sumber inspirasi bagi
              kamu yang ingin tampil elegan dan percaya diri setiap hari. Apakah
              kamu mencari referensi outfit untuk keseharian, tren fashion
              terbaru, atau panduan paduan warna yang tepat untuk setiap
              kesempatan? Di Vastra, kami menawarkan solusi gaya yang lengkap
          ...
          <div className="flex flex-col w-full md:w-1/2">
            <div className="relative group">
              ...
              >
                ...
                />
                <div className="absolute inset-0 flex items-center justify-center transition-opacity duration-300 ease-in-out opacity-100 group-hover:opacity-0">
                  <Text className="text-white text-2xl font-normal">Tips</Text>
                </div>
              </RouterLink>
            </div>
            <div className="relative group">
