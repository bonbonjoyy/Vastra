  ...
  return (
    <div className="font-sans text-gray-900 h-screen overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <h2 className="text-5xl font-bold mb-6">The Royal</h2>
          <p className="text-black mt-1 mb-8 text-justify">
            The Royal adalah pakaian yang dirancang untuk memberikan kesan megah dan elegan. Pakaian ini memiliki desain yang sederhana namun tetap elegan dan megah.
          </p>
          <button 
