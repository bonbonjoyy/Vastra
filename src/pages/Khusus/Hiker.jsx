  ...
  return (
    <div className="font-sans text-gray-900 h-screen overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <h2 className="text-5xl font-bold mb-6">Hiker</h2>
          <p className="text-black mt-1 mb-8 text-justify">
            Hiker adalah pakaian yang biasa digunakan oleh orang yang ingin mendaki gunung, pakaian ini seperti mantel, tetapi fungsi pakaian ini untuk mencegah pendaki merasa kedinginan atau mencegah terjadinya hipotermia.
          </p>
          <button 
