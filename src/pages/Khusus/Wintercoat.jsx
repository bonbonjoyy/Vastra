  ...
  return (
    <div className="font-sans text-gray-900 h-screen overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <h2 className="text-5xl font-bold mb-6">Winter Coat</h2>
          <p className="text-black mt-1 mb-8 text-justify">
          Winter coat adalah mantel musim dingin. Mantel musim dingin biasanya dibuat untuk menahan cuaca dingin, berangin, dan basah. Mantel ini memiliki insulasi tebal dan kain yang menolak air dan angin
          </p>
          <button 
