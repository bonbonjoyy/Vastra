      ...
      <div className="container-xs flex items-center justify-between gap-[2px] pr-24 w-full">
        ...
        <div className="flex gap-3 sm:gap-2 md:gap-6 lg:gap-7 relative md:mr-0">
          ...
          {isSearchVisible && (
            <form
              ref={searchRef}
              className="absolute right-24 sm:right-6 md:right-12 lg:right-24 mt-6 sm:mt-8 md:mt-10 w-32 sm:w-48 md:w-56 bg-white border border-gray-300 shadow-lg z-10"
            >
              <input
                type="text"
                placeholder="Cari..."
          ...
          <div
            ref={cartRef}
            className={`fixed top-[75px] sm:top-[72px] md:top-0 lg:top-0 right-0 h-[560px] sm:h-1/2 lg:h-full w-[300px] sm:w-[300px] md:w-[477px] lg:w-[577px] bg-white transform transition-transform duration-300 ease-in-out ${
                  ...
                  <div className="p-4 flex justify-between items-center">
                    ...
                    {cartItems.length > 0 && (
                      <button
                        ...
                        className="px-8 py-3 bg-black text-white font-bold hover:bg-gray-800"
                      >
                        Bayar
                      </button>
                    )}
